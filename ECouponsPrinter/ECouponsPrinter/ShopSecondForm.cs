...
{
    public partial class ShopSecondForm : Form
    {
        private Form parent;
        ...
        private void ShopSecond_FormLoad(object sender, EventArgs e)
        {
            //最大化窗口
        ...
        {
            this.Button_HomePage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\首页_1.jpg");
        }

        private void Button_HomePage_MouseUp(object sender, MouseEventArgs e)
        {
            this.Button_HomePage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\首页.jpg");
            this.Hide();
        ...
        {
            this.Button_ShopPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\商家.jpg");
            this.Hide();
        ...
        {
            this.Button_ShopPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\商家_1.jpg");
        }
        ...
        {
            this.Button_CouponsPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\优惠券.jpg");
            this.Hide();
        ...
        {
            this.Button_CouponsPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\优惠券_1.jpg");
        }
        ...
        {
            this.Button_MyInfoPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\我的专区.jpg");
            this.Hide();
        ...
        {
            this.Button_MyInfoPage.BackgroundImage = Image.FromFile(path + "\\images\\切图\\商家二级\\我的专区_1.jpg");
        }

        #endregion

        private void ShopSecond_FormClosing(object sender, FormClosingEventArgs e)
        {
