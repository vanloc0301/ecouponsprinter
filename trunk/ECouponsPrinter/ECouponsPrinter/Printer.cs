...
namespace Text
{
   ...
   string pDrive,
        ...
        public static string GetPrinterStat(string PrinterDevice)
        {
            string ret = "";
            string path = @"win32_printer.DeviceId='" + PrinterDevice + "'";
            ManagementObject printer = new ManagementObject(path);
            printer.Get();
            ret = ((PrinterStatus1)Convert.ToInt32(printer.Properties["PrinterStatus"].Value)).ToString();
            return ret;
        }
    }
